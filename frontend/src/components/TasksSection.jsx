      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.75)', marginBottom: 14, lineHeight: 1.5, fontWeight: 500 }}>
            We value creators on Base. Post <strong style={{ color: '#fff', fontWeight: 600 }}>quality content</strong> about our app and submit your link below to <strong style={{ color: '#fff', fontWeight: 600 }}>get 2 HP per day</strong>.
          </div>
          {isCheckingPost ? (
